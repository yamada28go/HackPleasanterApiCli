...

{
    ...
    public class InterfaceDefinition
    {
        ...
        /// 選択項目定義
        /// </summary>
        public List<Definition.ChoicesTextInfo> ChoicesTextInfos { get; set; } = new List<Definition.ChoicesTextInfo>();

        /// <summary>
        /// 選択子情報を持っているか判定する
        /// </summary>
        public bool HasChoicesTextInfos { get {

                if (null != ChoicesTextInfos) {

                    if (0 != ChoicesTextInfos.Count) {
                        return true;
                    }
                }
